...
```text
semantic/questions/<family>/family.yaml
semantic/questions/<family>/<question>.yaml
```

Family directories live directly under `semantic/questions/`; there is no additional taxonomy wrapper in the physical path.
...
Why is this being done?
        ↔
semantic/questions/teleological/why-is-this-being-done.yaml
```
