...
Patterns compose Core primitives into reusable semantic structures without promoting every important system concept into a new primitive.

v0.1 canonical pattern symbols are:

- `SemanticTrace` — reconstructable paths from Source to Finding and from Goal to StateChange;
...
Patterns retain stable IDs, are referencable and testable by canonical symbol, and remain explicitly marked `not_a_primitive: true`.
